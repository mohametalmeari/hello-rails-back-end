...
<div align="center">
  ...
  <h1><b>Hello! - Back End API - README</b></h3>
...
```sh
  cd my-folder
  git clone https://github.com/mohametalmeari/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/mohametalmeari/hello-rails-back-end/issues).
...
> The original idea for this api was created by Microverse Team.
